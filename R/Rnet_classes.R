...
#' @Layout A k' x 2 matrix containing the x & y coords for the vertices for plotting. k' indicates that some of the k vertices declared may have been removed.
#' @export
#' 
...
#'@Edge_stability A dataframe showing edge stability over the set of generated networks.
#'@StARS_D A vector of D_b values used for L1 selection.
